...
starting_tools = [
    ...
    },
    {
        ...
        "function": {
            ...
            "description": "读取本地目录下的特定文件",
            "parameters": {
                "type": "object",
                "properties": {
                    "file_path": {
                        "type": "string",
                        "description": "文件的完整路径，例如：'/path/to/file.txt'",
                    },
                },
                "required": ["file_path"],
            },
...
def run_action(thread_id, run_id):
    ...
    for tool in run.required_action.submit_tool_outputs.tool_calls:
        ...
        elif tool.function.name == "readFileContent":
            arguments = json.loads(tool.function.arguments)
...
def main():
    ...
    if 1==1:
        ...
        user_message = "读取文件'/Users/a0000/mywork/commonLLM/opensource/openai-tool-use-quickstart/test.txt'"
